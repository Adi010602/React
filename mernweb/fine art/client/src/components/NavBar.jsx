...
const Navbar = () => {
  ...
  <div className="container">
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <NavLink className="navbar-brand mx-auto fw-bolder fs-4" to="#">Navbar</NavLink>
      <form className="d-flex" role="search">
      
        <NavLink to="/login" className="btn btn-outline-primary ms-2 px-4 rounded-pill"><i className="fa fa-user-plus me-2"></i> Login</NavLink>
